 ...
 @Entity
 @XmlRootElement
 @NamedQueries({@javax.persistence.NamedQuery(name="Parametrage.findAll", query="SELECT p FROM Parametrage p"), @javax.persistence.NamedQuery(name="Parametrage.findById", query="SELECT p FROM Parametrage p WHERE p.id = :id"), @javax.persistence.NamedQuery(name="Parametrage.findByNomStructure", query="SELECT p FROM Parametrage p WHERE p.nomStructure = :nomStructure"), @javax.persistence.NamedQuery(name="Parametrage.findByBoitePostale", query="SELECT p FROM Parametrage p WHERE p.boitePostale = :boitePostale"), @javax.persistence.NamedQuery(name="Parametrage.findByContact1", query="SELECT p FROM Parametrage p WHERE p.contact1 = :contact1"), @javax.persistence.NamedQuery(name="Parametrage.findByContact2", query="SELECT p FROM Parametrage p WHERE p.contact2 = :contact2"), @javax.persistence.NamedQuery(name="Parametrage.findByContact3", query="SELECT p FROM Parametrage p WHERE p.contact3 = :contact3"), @javax.persistence.NamedQuery(name="Parametrage.findByDescriptif", query="SELECT p FROM Parametrage p WHERE p.descriptif = :descriptif"), @javax.persistence.NamedQuery(name="Parametrage.findByRcm", query="SELECT p FROM Parametrage p WHERE p.rcm = :rcm"), @javax.persistence.NamedQuery(name="Parametrage.findByNoContrib", query="SELECT p FROM Parametrage p WHERE p.noContrib = :noContrib"), @javax.persistence.NamedQuery(name="Parametrage.findByLocalisation", query="SELECT p FROM Parametrage p WHERE p.localisation = :localisation"), @javax.persistence.NamedQuery(name="Parametrage.findByRepertoireLogo", query="SELECT p FROM Parametrage p WHERE p.repertoireLogo = :repertoireLogo"), @javax.persistence.NamedQuery(name="Parametrage.findByLogo", query="SELECT p FROM Parametrage p WHERE p.logo = :logo"), @javax.persistence.NamedQuery(name="Parametrage.findByRepertoireSauvegardre", query="SELECT p FROM Parametrage p WHERE p.repertoireSauvegardre = :repertoireSauvegardre"), @javax.persistence.NamedQuery(name="Parametrage.findByTauxTva", query="SELECT p FROM Parametrage p WHERE p.tauxTva = :tauxTva"), @javax.persistence.NamedQuery(name="Parametrage.findByCapital", query="SELECT p FROM Parametrage p WHERE p.capital = :capital"), @javax.persistence.NamedQuery(name="Parametrage.findByTauxRemise", query="SELECT p FROM Parametrage p WHERE p.tauxRemise = :tauxRemise"), @javax.persistence.NamedQuery(name="Parametrage.findByCheminTemplate", query="SELECT p FROM Parametrage p WHERE p.cheminTemplate = :cheminTemplate"), @javax.persistence.NamedQuery(name="Parametrage.findByEtatQuantiteDosage", query="SELECT p FROM Parametrage p WHERE p.etatQuantiteDosage = :etatQuantiteDosage"), @javax.persistence.NamedQuery(name="Parametrage.findByEtatFormeProduit", query="SELECT p FROM Parametrage p WHERE p.etatFormeProduit = :etatFormeProduit"), @javax.persistence.NamedQuery(name="Parametrage.findByEtatFormeStockage", query="SELECT p FROM Parametrage p WHERE p.etatFormeStockage = :etatFormeStockage"), @javax.persistence.NamedQuery(name="Parametrage.findByCalcultva", query="SELECT p FROM Parametrage p WHERE p.calcultva = :calcultva"), @javax.persistence.NamedQuery(name="Parametrage.findByCalculRemise", query="SELECT p FROM Parametrage p WHERE p.calculRemise = :calculRemise"), @javax.persistence.NamedQuery(name="Parametrage.findByFax", query="SELECT p FROM Parametrage p WHERE p.fax = :fax"), @javax.persistence.NamedQuery(name="Parametrage.findByNbreJrAlertePeremption", query="SELECT p FROM Parametrage p WHERE p.nbreJrAlertePeremption = :nbreJrAlertePeremption"), @javax.persistence.NamedQuery(name="Parametrage.findByPourcentageBailleur", query="SELECT p FROM Parametrage p WHERE p.pourcentageBailleur = :pourcentageBailleur"), @javax.persistence.NamedQuery(name="Parametrage.findByBanque", query="SELECT p FROM Parametrage p WHERE p.banque = :banque"), @javax.persistence.NamedQuery(name="Parametrage.findByNumeroCompte", query="SELECT p FROM Parametrage p WHERE p.numeroCompte = :numeroCompte"), @javax.persistence.NamedQuery(name="Parametrage.findByEtatbailleur", query="SELECT p FROM Parametrage p WHERE p.etatbailleur = :etatbailleur"), @javax.persistence.NamedQuery(name="Parametrage.findByEtatuser", query="SELECT p FROM Parametrage p WHERE p.etatuser = :etatuser")})
 ...
 * Qualified Name:     entities.Parametrage
