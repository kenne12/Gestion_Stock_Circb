 ...
 @Entity
 @XmlRootElement
 @NamedQueries({@javax.persistence.NamedQuery(name="Mouchard.findAll", query="SELECT m FROM Mouchard m"), @javax.persistence.NamedQuery(name="Mouchard.findByIdmouchard", query="SELECT m FROM Mouchard m WHERE m.idmouchard = :idmouchard"), @javax.persistence.NamedQuery(name="Mouchard.findByAction", query="SELECT m FROM Mouchard m WHERE m.action = :action"), @javax.persistence.NamedQuery(name="Mouchard.findByDate", query="SELECT m FROM Mouchard m WHERE m.date = :date"), @javax.persistence.NamedQuery(name="Mouchard.findByHeure", query="SELECT m FROM Mouchard m WHERE m.heure = :heure")})
 ...
 * Qualified Name:     entities.Mouchard
